...
const TendFieldsPanel = () => {
  ...
  const [cropTypeFilter, setCropTypeFilter] = useState<CropType | string>(
    "all"
  );
  const [cropVariantFilter, setCropVariantFilter] = useState<
    CropVariant | string
  >("all");
  const [cropStatusFilter, setCropStatusFilter] = useState<CropStatus | string>(
    "all"
  );
  ...
  // TODO: remove the following (here to fix build errors)
  getCropProfile(CropType.CANOLA);
  setCrops(null);
  console.log(
    cropTypeFilter,
    cropVariantFilter,
              ...
              <form className={styles.FilterCrops}>
                <section>
                  ...
                  <select
                    ...
                    defaultValue={"all"}
                    onChange={(e) => {
                      setCropTypeFilter(e.target.value as CropType);
                    }}
                  >
                ...
                <section>
                  ...
                  <select
                    ...
                    defaultValue={"all"}
                    onChange={(e) => {
                      setCropVariantFilter(e.target.value as CropVariant);
                    }}
                  >
                    <option value="all">All</option>
                ...
                <section>
                  ...
                  <select
                    ...
                    defaultValue={"all"}
                    onChange={(e) => {
                      setCropStatusFilter(e.target.value as CropStatus);
                    }}
                  >
                    <option value="all">All</option>
                ...
                <section>
                  ...
                  <input
                    ...
                    max={9999}
                    onChange={(e) => {
                      setMinQuantityFilter(parseInt(e.target.value));
                    }}
                  />
                </section>
                ...
                <section>
                  ...
                  <input
                    ...
                    max={9999}
                    onChange={(e) => {
                      setMaxQuantityFilter(parseInt(e.target.value));
                    }}
                  />
                </section>
            ...
            crops.map((crop, index) => (
              <fieldset key={index} className={styles.CropInfo}>
                ...
                <div className={styles.Info}>
                  ...
                  <section>
                    <p>
                      Variant: <b>{crop.cropVariant}</b>
                    </p>
                    <p>
                      Quantity: <b>{crop.quantity}</b>
                    </p>
                    <p>
                      Crop Status: <b>{crop.cropStatus}</b>
                    </p>
                  </section>
                </div>
              </fieldset>
